...
// Alert Hello World
//alert("Hello World");
    console.log("***Goal one Basics is working");
    document.write("***Goal one Basics is working");
    /*
     Variables
...
// variables
    ...
    var name = "Rashaad", course = "PWA-1", month = "January";
    ...
    document.write("<br>" + name1, name2, name3);

    //example 3: a mix of variables defined and not defined
    var name3, course3 = "PWA3", month3;
...
// string (definition, concatenation, escape character)
    ...
    //basic string
    var name4 = "Tasha Page-Lockhart";
    var course4 = "Im different";
    var month4 = 1;
    ...
    console.log("Jayz song is 99 problems." + testString3);
    document.write("<br>" + "Jayz song is 99 problems." + testString3);
...
// numbers (definition, concatenation +, math, numbers & strings)
    ...
    //basic math
    var num = 10;
    console.log("Rashaad's Basis Number works:" + num);
    document.write("Rashaad's Basis Math works:" + num);

    var counter = 10;
    console.log("Rashaad's Basis Counter works:", +counter + 1);
    document.write("<br>" + "Rashaad's Basis Math works:", +counter + 1);
    ...
    document.write("The+=operator is a faster way to add 2 numbers:", num1 + num2);
    //increment or decrement numbers by 1 with ++ or --
    var myNum = 5;
    console.log("Just myNum");
    console.log("<br>", "Just myNum=", myNum);

    myNum++;
    console.log("But myNum++ increases by", myNum);
    document.write("<br>", +"But myNum-- increases to", myNum);
    //this decrements right before it is being used
    --num;//started out as 10 under basic math,
    console.log("--PRE Decrement Counter:", num);
    document.write("<br>" + "--PRE Decrement Counter:", num);
    //this decrements after it is used
    num--;//started out as 10 under basic math,
    console.log("--Post Decrement Counter:", num);
    document.write("<br>" + "--Post Decrement Counter:", num);
    //comment out the above example
    //this decrements after it is being used as well
    console.log("Near Line 142, Counter--results in:", num--);
    document.write("<br>" + "Near Line 142, Counter--results in:", num--);

    //add a number to a string is always a string
    var myStr = "6" + 2;
    console.log("Number+ Strings:", myStr);
    document.write("<br>", "Number+String:", myStr);
...
// arrays: (definition, indexing, getter/setter)
    ...
    console.log("index0:", myArr[0]);
    document.write("<br>" + "index0:", myArr[0]);

    console.log("index0:", myArr[1]);
    document.write("<br>" + "index0:", myArr[1]);

    console.log("index0:", myArr[2]);
    document.write("<br>" + "index0:", myArr[2]);

    console.log("index0:", myArr[3]);
    document.write("<br>" + "index0:", myArr[3]);
    /*
    ...
    document.write("<br>" + array1[0] + array1[1] + array1[2] + array1[3]);
    ...
    if (a < b) {
        ...
        console.log("<br>", "if-else the 'IF' statement is false");
    }
    ;
 ...
 *****************************
    ...
    - traditional programmers like the basic because they can create it and call from anywhere
     ...
     - type the below as an example
        functionName();
 *****************************
*/ var myctr=1;  //intialize our variable to 1-GLOBAL var
 ...
 ********************************************/
    ...
    var myctr=1;//initialize our variable to 1-Global
